  ...
  return Container(
    ...
    child: ElevatedButton(
      ...
      child: Text(
        'LOGIN',
        style: TextStyle(
          color: Color.fromARGB(255, 82, 170, 151),
          letterSpacing: 1.5,
          fontSize: 18.0,
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Color(0xFF73AEF5),
                      Color(0xFF61A4F1),
                      Color.fromARGB(255, 71, 206, 224),
                      Color.fromARGB(255, 57, 229, 215),
                    ],
...
```
4. Pada file pubspec.yaml menambahkan kode untuk assets agar gambar dapat diakses.
```
...
<img src="./ss/ssssssssssssssssss.png" style="margin: auto; width:400px;">